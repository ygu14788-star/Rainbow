...
export const COLLECTIONS = [
  ...
  { id: 'accessories', img: IMG('col-accessories.jpg'), zh: 'Accessories', en: '配饰系列',  desc: 'Selected knitted accessories, from scarves and hats to exquisite gloves, embellish the beauty of details.' },
];
...
export const VISION = [
  { period: '', desc: ' Become a technology leader in 3D seamless knitting and a new image of Chinese manufacturing.' },
];
