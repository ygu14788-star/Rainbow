...
export const PRODUCTS = [
  ...
  { id: 'zip', img: IMG('p-zip.jpg'), name: '美利奴半拉链毛衣', en: 'Merino Half-Zip', series: ['golf', 'trail'],
  ...
  { id: 'hoodie', img: IMG('p-hoodie.jpg'), name: '细针距针织连帽衫', en: 'Fine-Gauge Knit Hoodie', series: ['ski', 'trail'],
...
export const TECHS = [
  ...
  { img: IMG('proc-machine.jpg'), title: '精密设备', desc: '高端针织设备，确保织造稳定性与一致性，成就每一件高品质针织作品。',
